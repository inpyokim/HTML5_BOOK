...
$(document).ready(function() {
	...
	$.loadLocalTweets = function(position) {
		var apiUrl = 'http://api.twitter.com/1.1/search/tweets.json?q=seoul&rpp=100&geocode=' + position.coords.latitude + ',' + position.coords.longitude + ',20km';
		var requestUrl = '../../Common/curl.php?apiUrl=' + escape(apiUrl);
