...
$(document).ready(function() {
	...
	$.loadMap = function(position) {
		...
		var latLng = new google.maps.LatLng(37.500635, 127.036389);
	...
	$.loadLocalTweets = function(position) {
		var apiUrl = 'http://api.twitter.com/1.1/search/tweets.json?q=%EC%82%BC%EC%84%B1&rpp=100&geocode=37.500635,127.036389,10km';
		var requestUrl = '../../Common/curl.php?apiUrl=' + escape(apiUrl);
